/* Copyright 2023-2024 Luke Marzen
 *
...
[_QWERTY] = LAYOUT_planck_grid(
    ...
    KC_LCTL, KC_LGUI, KC_LALT, _______, LOWER,   KC_RSFT, KC_SPC,  RAISE,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
),
 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |  F7  |  F8  |  F9  |  F10 |  F11 |  F12 |ISO ~ |ISO | | End  | Home |      |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |      |      |      |      |             |      |      | Bri- | Bri+ |      |
 * `-----------------------------------------------------------------------------------'
 */
 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Caps |      |MUSmod|Aud on|Audoff|      |      |Qwerty|Colemk|Dvorak|Plover|      |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
...
[_ADJUST] = LAYOUT_planck_grid(
    ...
    KC_CAPS, EE_CLR,  MU_NEXT, AU_ON,   AU_OFF,  _______, _______, _______, _______, _______, _______, _______,
